...
class Admin extends CI_Controller
{
    ...
    public function index()
    {
        ...
        // $data['statusCount'] = $this->model_surat->statusSuratCount();
        ...
        $data['ftk'] = $this->db->query("SELECT * FROM detail_user JOIN surat_masuk on detail_user.nim=surat_masuk.nim JOIN detail_surat_tugas ON surat_masuk.id_surat=detail_surat_tugas.id_surat WHERE fakultas LIKE 'Tarbiyah dan Keguruan%' AND status_surat = 'Selesai' ")->num_rows();
        $data['ush'] = $this->db->query("SELECT * FROM detail_user JOIN surat_masuk on detail_user.nim=surat_masuk.nim JOIN detail_surat_tugas ON surat_masuk.id_surat=detail_surat_tugas.id_surat WHERE fakultas LIKE 'Ushuluddin%' AND status_surat = 'Selesai' ")->num_rows();
        $data['psi'] = $this->db->query("SELECT * FROM detail_user JOIN surat_masuk on detail_user.nim=surat_masuk.nim JOIN detail_surat_tugas ON surat_masuk.id_surat=detail_surat_tugas.id_surat WHERE fakultas LIKE 'Psikologi%' AND status_surat = 'Selesai' ")->num_rows();
        $data['fekonsos'] = $this->db->query("SELECT * FROM detail_user JOIN surat_masuk on detail_user.nim=surat_masuk.nim JOIN detail_surat_tugas ON surat_masuk.id_surat=detail_surat_tugas.id_surat WHERE fakultas LIKE 'Ekonomi dan Ilmu Sosial%' AND status_surat = 'Selesai' ")->num_rows();
        $data['sih'] = $this->db->query("SELECT * FROM detail_user JOIN surat_masuk on detail_user.nim=surat_masuk.nim JOIN detail_surat_tugas ON surat_masuk.id_surat=detail_surat_tugas.id_surat WHERE fakultas LIKE 'Syariah dan Ilmu Hukum%' AND status_surat = 'Selesai' ")->num_rows();
        $data['fdk'] = $this->db->query("SELECT * FROM detail_user JOIN surat_masuk on detail_user.nim=surat_masuk.nim JOIN detail_surat_tugas ON surat_masuk.id_surat=detail_surat_tugas.id_surat WHERE fakultas LIKE 'Dakwah dan Ilmu Komunikasi%' AND status_surat = 'Selesai' ")->num_rows();
        $data['fst'] = $this->db->query("SELECT * FROM detail_user JOIN surat_masuk on detail_user.nim=surat_masuk.nim JOIN detail_surat_tugas ON surat_masuk.id_surat=detail_surat_tugas.id_surat WHERE fakultas LIKE 'Sains dan Teknologi%' AND status_surat = 'Selesai' ")->num_rows();
        $data['perta'] = $this->db->query("SELECT * FROM detail_user JOIN surat_masuk on detail_user.nim=surat_masuk.nim JOIN detail_surat_tugas ON surat_masuk.id_surat=detail_surat_tugas.id_surat WHERE fakultas LIKE 'Pertanian dan Peternakan%' AND status_surat = 'Selesai' ")->num_rows();
        $data['pasca'] = $this->db->query("SELECT * FROM detail_user JOIN surat_masuk on detail_user.nim=surat_masuk.nim JOIN detail_surat_tugas ON surat_masuk.id_surat=detail_surat_tugas.id_surat WHERE fakultas LIKE 'Pascasarjana%' AND status_surat = 'Selesai' ")->num_rows();
        ...
        // $data['admn'] = $this->db->query("SELECT * FROM dosen JOIN surat_masuk on dosen.nip=surat_masuk.nip JOIN detail_surat_tugas ON surat_masuk.id_surat=detail_surat_tugas.id_surat WHERE prodi LIKE 'Administrasi Negara%' AND status_surat = 'Selesai' ")->num_rows();
