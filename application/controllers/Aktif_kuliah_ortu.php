...
class Aktif_kuliah_ortu extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $this->form_validation->set_rules('tahun_akademik_kegiatan', 'Tahun Akademik_Kegiatan', 'trim|required');
        $this->form_validation->set_rules('nama_wali', 'Nama Wali', 'trim|required');
        $this->form_validation->set_rules('nopen', 'NIP NPW NOPEN', 'trim|required');
        $this->form_validation->set_rules('pangkat', 'Pangkat', 'trim|required');
        $this->form_validation->set_rules('instansi', 'instansi', 'trim|required');

        if ($this->form_validation->run() == false) {
            $data['judul'] = "SIM - Ajukan Surat Aktif Kuliah Dengan Ortu";
            ...
            $this->load->view('surat/aktif_kuliah_ortu', $data);
