...
class Izin_perusahaan extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $this->form_validation->set_rules('tahunkegiatan', 'tahunkegiatan', 'trim|required');

        if ($this->form_validation->run() == false) {
            $data['judul'] = "SIM - Ajukan Surat Keterangan Izin Perusahaan";
            ...
            $this->load->view('surat/izin_perusahaan', $data);
