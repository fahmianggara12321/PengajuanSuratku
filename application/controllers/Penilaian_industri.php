...
class Penilaian_industri extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $this->form_validation->set_rules('lokasi_pkl_industri', 'Lokasi PKL Industri', 'trim|required');

        if ($this->form_validation->run() == false) {
            $data['judul'] = "SIM - Ajukan Surat Penilaian PKL (Teknik Industri)";
            ...
            $this->load->view('surat/penilaian_industri', $data);
