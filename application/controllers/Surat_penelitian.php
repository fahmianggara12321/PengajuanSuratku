...
class Surat_penelitian extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $this->form_validation->set_rules('tempat_penelitian', 'Nama Tempat Penelitian', 'trim|required');
        $this->form_validation->set_rules('lokasi_penelitian', 'Lokasi Penelitian', 'trim|required');

        if ($this->form_validation->run() == false) {
            $data['judul'] = "SIM - Ajukan Surat Penelitian";
            ...
            $this->load->view('surat/surat_penelitian', $data);
