...
{
    function daftar_surat($jenis_surat, $prodi)
    {
        $this->db->select('no_surat');
        $this->db->order_by("id_detail_surat", "desc");
        $this->db->where('jenis_surat', $jenis_surat);
        $this->db->where('prodi', $prodi);
        $query = $this->db->get('detail_surat_tugas');
        return $query;
    }
    ...
    function detail_suratMasuk($id)
    {
        ...
        $this->db->join('surat_masuk', 'surat_masuk.id_surat=detail_surat_tugas.id_surat');
        $this->db->join('detail_user', 'detail_user.nim=surat_masuk.nim');
        $this->db->join('ttd', 'ttd.prodi=detail_surat_tugas.prodi');
    ...
    public function update_surat()
    {
        ...
        if ($rekom_dinas === "Iya") {
            $data['surat'] = $this->db->get_where('detail_surat_tugas', ['nim' => $this->session->userdata('nim')])->row_array();
