                        ...
                        <div class="card-content">
                            ...
                            <div class="checkbox text-rose">
                                <label>
                                    ...
                                    <span class="text-rose">Isi jika tersedia berkas lain</span>
                                </label>
                            </div>
                            <div id="formbaru" style="display:none;">
                                <div>
                                    <label for="foto_ktp">Foto KTM<span class="text-danger">*</span></label>
                    ...
                    <div class="card shadow">
                        ...
                        <div class="card-content">
                            ...
                            <div class="form-group label-floating after-add-more">
                                <div class="row">
                                    <div class="col-md-7">
                                        <input type="text" name="nipajukan[]" id="nim" class="form-control" placeholder="Masukkan NIP" required>
                                    </div>
                                    <div class="col-md-4">
