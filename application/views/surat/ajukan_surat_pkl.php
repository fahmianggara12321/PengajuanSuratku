    <div class="content">
        <div class="container-fluid">
            <?php
            echo form_open_multipart('ajukan_surat_pkl', 'role="form" class="form" id="save" ');
            ?>
            <div class="row">
                <div class="col-lg-6">
                    <div class="card shadow">
                        ...
                        <div class="card-content">
                            ...
                            <div class="form-group label-floating" style="display: none;">
                                ...
                                <input type="hidden" class="form-control form-control-user" id="jenis_surat" name="jenis_surat" value="Ajukan Surat PKL">
                            </div>
							...
							<div class="form-group label-floating">
                                <label>Nama Tempat PKL<span class="text-danger">*</span></label>
                                <?= form_error('tempat_pkl', '<small class="text-danger pl-3">', '</small>'); ?>
                                <input type="text" class="form-control form-control-user" id="tempat_pkl" name="tempat_pkl">
                            </div>
							<div class="form-group label-floating">
                                <label>Lokasi PKL<span class="text-danger">*</span></label>
                                <?= form_error('lokasi_pkl', '<small class="text-danger pl-3">', '</small>'); ?>
                                <input type="text" class="form-control form-control-user" id="lokasi_pkl" name="lokasi_pkl">
                            </div>
                            <div class="form-group label-floating" style="display: none;">
                    ...
                    <div class="card shadow">
                        ...
                        <div class="card-content">
                            ...
                            <div class="form-group label-floating after-add-more">
                                <div class="row">
                                    <div class="col-md-6">
                                        <input type="text" name="nim1" id="nim1" class="form-control" placeholder="Masukkan NIM">
                                    </div>
                                    <div class="col-md-6">
                                        <input type="text" name="nama1" id="nama1" class="form-control" placeholder="Masukkan Nama">
                                    </div>
                                    <div class="col-md-1">
                                    </div>
                                </div>
                            ...
                            <script type="text/javascript">
                                $("#nim1").autocomplete({
                                    source: "<?php echo site_url('ajukan_surat_pkl/get_nip_dosen'); ?>",
                                    select: function(event, ui) {
                                        $('[name="nim1"]').val(ui.item.label);
                                    }
                                });
                            </script>
                            <script type="text/javascript">
                                $("#nama1").autocomplete({
                                    source: "<?php echo site_url('ajukan_surat_pkl/get_nama_dosen'); ?>",
                                    select: function(event, ui) {
                                        $('[name="nama1"]').val(ui.item.label);
                                    }
                                });
                            </script>
                        </div>
