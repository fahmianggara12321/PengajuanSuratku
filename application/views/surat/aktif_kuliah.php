    <div class="content">
        <div class="container-fluid">
            <?php
            echo form_open_multipart('aktif_kuliah', 'role="form" class="form" id="save" ');
            ?>
            <div class="row">
                <div class="col-lg-12">
                    <div class="card shadow">
                        ...
                        <div class="card-content">
                            ...
                            <div class="form-group label-floating" style="display: none;">
                                ...
                                <input type="hidden" class="form-control form-control-user" id="jenis_surat" name="jenis_surat" value="Ajukan Surat Aktif Kuliah">
                            </div>
                            <div class="form-group label-floating" style="display: none;">
                                <label><span class="text-danger"></span></label>
                                <?= form_error('jk', '<small class="text-danger pl-3">', '</small>'); ?>
                                <input type="hidden" class="form-control form-control-user" id="jk" name="jk">
                            </div>
                    ...
                    <div class="card shadow">
                        ...
                        <div class="card-content">
                            ...
                            <div class="form-group label-floating after-add-more">
                                <div class="row">
                                    <div class="col-md-7">
                                    <input type="text" name="nipajukan[]" id="nim" class="form-control" placeholder="Masukkan NIM" value="" required>                                    <div class="col-md-4">
