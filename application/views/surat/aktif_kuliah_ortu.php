    <div class="content">
        <div class="container-fluid">
            <?php
            echo form_open_multipart('aktif_kuliah_ortu', 'role="form" class="form" id="save" ');
            ?>
            <div class="row">
                <div class="col-lg-12">
                    <div class="card shadow">
                        ...
                        <div class="card-content">
                            ...
                            <div class="form-group label-floating" style="display: none;">
                                ...
                                <input type="hidden" class="form-control form-control-user" id="jenis_surat" name="jenis_surat" value="Ajukan Surat Aktif Kuliah Dengan Ortu">
                            </div>
                            ...
                            <div class="form-group label-floating">
                                <label>Tahun Akademik Saat ini <span class="text-danger">*</span></label>
                                <?= form_error('judul_penelitian', '<small class="text-danger pl-3">', '</small>'); ?>
                                <input type="text" class="form-control form-control-user" id="tahun_akademik_kegiatan" placeholder="2021/2022" name="tahun_akademik_kegiatan">
                            </div>
                            <div class="form-group label-floating">
                                <label>Nama Wali<span class="text-danger">*</span></label>
                                <?= form_error('lokasi_penelitian', '<small class="text-danger pl-3">', '</small>'); ?>
                                <input type="text" class="form-control form-control-user" id="nama_wali" name="nama_wali">
                            </div>
							<div class="form-group label-floating">
                                <label>NIP/NRP/NVP/NOPEN<span class="text-danger">*</span></label>
                                <?= form_error('lokasi_penelitian', '<small class="text-danger pl-3">', '</small>'); ?>
                                <input type="text" class="form-control form-control-user" id="nopen" name="nopen">
                            </div>
							<div class="form-group label-floating">
                                <label>Pangkat/Gol.Ruang<span class="text-danger">*</span></label>
                                <?= form_error('lokasi_penelitian', '<small class="text-danger pl-3">', '</small>'); ?>
                                <input type="text" class="form-control form-control-user" id="pangkat" name="pangkat">
                            </div>
							<div class="form-group label-floating">
                                <label>Instansi/Unit Kerja<span class="text-danger">*</span></label>
                                <?= form_error('lokasi_penelitian', '<small class="text-danger pl-3">', '</small>'); ?>
