...
<body>
    ...
    <div class="content">
        ...
        <table>
            <tr>
                <td style="vertical-align:top;padding-right:70px;"></td>
                <td style="vertical-align:top;padding-right:17px;">Adalah benar-benar Mahasiswa Universitas Muhammadiyah Sidoarjo dengan data sbb,</td>
                <td style="text-align: justify;">
                </td>
            </tr>
        </table>
        <table>
            <tr>
                ...
                <tr>
                    ...
                    <td> : </td>
                    <td><?= $detail['tahun_akademik_kegiatan']?></td>
                </tr>
                <tr>
                <td style="vertical-align:top;padding-right:50px;"></td>
            </tr>
        ...
        <table>
            <tr>
                <td style="vertical-align:top;padding-right:70px;"></td>
                <td style="vertical-align:top;padding-right:17px;">Adapun wali mahasiswa tersebut diatas adalah,</td>
                <td style="text-align: justify;">
                </td>
            </tr>
        </table>
        ...
        <table>
            <tr>
                <td style="vertical-align:top;padding-right:70px;"></td>
                <td style="vertical-align:top;padding-right:17px;">Demikian surat ini dibuat dengan sesungguhnya, dan dapat dipergunakan sebagaimana mestinya.</td>
                <td style="text-align: justify;">
                </td>
            </tr>
        </table>
