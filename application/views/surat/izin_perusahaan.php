	<div class="content">
        <div class="container-fluid">
            <?php
            echo form_open_multipart('izin_perusahaan', 'role="form" class="form" id="save" ');
            ?>
            <div class="row">
                <div class="col-lg-12">
                    <div class="card shadow">
                        ...
                        <div class="card-content">
                            ...
                            <div class="form-group label-floating" style="display: none;">
                                ...
                                <input type="hidden" class="form-control form-control-user" id="jenis_surat" name="jenis_surat" value="Ajukan Surat Keterangan Izin Perusahaan">
                            </div>
							<div class="form-group label-floating">
                                <label>Kegiatan<span class="text-danger">*</span></label>
                                <?= form_error('tujuan_penelitian', '<small class="text-danger pl-3">', '</small>'); ?>
								<p> <select id="kegiatan" class="form-control form-control-user" name="kegiatan">
                            ...
                            <div class="form-group label-floating">
                                ...
                                <input type="text" name="tanggal_kegiatan" min="<?= $tanggal ?>" class="form-control">
                                <script>
                            ...
                            <div class="form-group label-floating">
                                ...
                                <?= form_error('judul_penelitian', '<small class="text-danger pl-3">', '</small>'); ?>
                                <input type="text" class="form-control form-control-user" id="jam" placeholder="06.00" name="jam">
                            </div>
                            <div class="form-group label-floating">
                                <label>Tahun akademik kegiatan<span class="text-danger">*</span></label>
                                <?= form_error('judul_penelitian', '<small class="text-danger pl-3">', '</small>'); ?>
                                <input type="text" class="form-control form-control-user" id="tahunkegiatan" placeholder="2019/2020" name="tahunkegiatan">
                            </div>
                        ...
                        <div class="col-lg-6" style="display: none;">
                            ...
                            <div class="card-content">
                                ...
                                <div class="form-group label-floating after-add-more">
                                    <div class="row">
                                        <div class="col-md-7">
                                        <input type="text" name="nipajukan[]" id="nim" class="form-control" placeholder="Masukkan NIM" value="" required>                                        </div>
                                    <div class="col-md-4">
