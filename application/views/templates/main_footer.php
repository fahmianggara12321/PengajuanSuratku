<footer class="footer">
    <div class="container-fluid">
        <p class="copyright pull-right">
            ...
            <a href="" target="_blank">KenaTipu</a>, website percobaan
        </p>
    </div>
    <!-- Logout Modal-->
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Sudah Selesai Semua?</h5>
                </div>
                <div class="modal-body">Apakah Anda yakin Ingin Keluar Sekarang?</div>
...
<!-- sweetalert2 -->
<script src="<?= base_url(); ?>/assets/vendor/sweetalert2/dist/sweetalert.min.js"></script>
<script src="<?= base_url(); ?>/assets/vendor/sweetalert2/dist/sweetalert-dev.js"></script>
