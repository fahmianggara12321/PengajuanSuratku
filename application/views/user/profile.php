            ...
            <div class="col-md-8">
                <div class="card">
                    ...
                    <div class="card-content">
                        <h4 class="card-title">Akun Saya -
                            <small class="category">Lengkapi akun</small>
                        </h4>
                        ...
                        <button type="submit" onclick="submitOne()" class="btn btn-rose pull-right">Perbarui Profil</button>
            ...
            <div class="col-md-4">
                ...
                <div class="card card-profile">
                    <div class="fileinput fileinput-new text-center" data-provides="fileinput">
                        ...
                        <div>
                            <span class="btn btn-round btn-rose btn-file">
                                <span class="fileinput-new">Perbarui Foto</span> <span class="fileinput-exists">Lainnya</span>
                                <input type="hidden" value="<?= $user['nip'] ?>" name="nip">
                    ...
                    <div class="card-content">
                        ...
                        <br>
                        <h6 class="card-title">Universitas Nan Jauh Di Ujung Sana</h6>
                    </div>
                </div>
                </form>
            </div>
