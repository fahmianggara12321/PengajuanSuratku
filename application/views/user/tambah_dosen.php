<div class="content">
    <div class="container-fluid">
        ...
        <?php
        echo form_open_multipart('user_management/tambah', 'role="form" class="form" id="tambah"');
        ?>
        <div class="row">
            <div class="col-lg-12">
                <div class="card shadow">
                    ...
                    <div class="card-content">
                        <h4 class="card-title">Isi Data User</h4>
                        ...
                        <!-- hak akses  -->
                        <div class="form-group label-floating">
                            <label>Hak Akses Sistem<span class="text-danger">*</span></label>
                            <?= form_error('id_user_type', '<small class="text-danger pl-3">', '</small>'); ?>
                            <select class="selectpicker" name="id_user_type" data-style="select-with-transition" title="pilih" data-size="7">
                                <option disabled> Hak Akses</option>
                                <option value="1">Staff LPPM</option>
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group label-floating">
                                    ...
                                    <input type="text" class="form-control form-control-user" id="gelar_depan" name="gelar_depan">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group label-floating">
                            ...
                            <div class="col-md-4">
                                <div class="form-group label-floating">
                                    ...
                                    <input type="text" class="form-control form-control-user" id="gelar_belakang" name="gelar_belakang">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-3">
                                <div class="form-group label-floating">
                                    ...
                                    <input type="text" class="form-control form-control-user" id="pangkat_gol" name="pangkat_gol">
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group label-floating">
                            ...
                            <div class="col-md-3">
                                <div class="form-group label-floating">
                                    ...
                                    <input type="text" class="form-control form-control-user" id="spesialisasi" name="spesialisasi">
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group label-floating">
        ...
        <div class="row ">
            ...
            <div class="col-lg-4 ">
                <a type="submit" id='tambah' class="btn btn-primary btn-block tambah">
                    Tambah
                </a>
            </div>
            <div class="col-md-4"></div>
...
<!-- script untuk menampilkan notice sebelum tambah -->
<script>
    $('.tambah').on("click", function(e) {
        e.preventDefault();
        var url = $(this).parents('#tambah');
        swal({
                title: "Are you sure?",
...
<script>
    function tampilkan() {
        var nama_fakultas = document.getElementById("tambah").fakultas.value;
